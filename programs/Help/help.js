...
new explorer.window()
.title('Block Browser - ByteNest Help') //set the title
.resize(960, 480) //set the dimentions
.icon('programs/Help/1.png') //set the icon
...
.callback(function() {
	...
	bod.html('<button class="b1">🢀</button><button class="b2">🢂</button><input class="i1"></input><button class="b3">Go</button><iframe src="http://cdn.ByteNest.co.uk/website-help/" class="if1"></iframe>');
	...
	function startTracker() {
		...
		var interval = setInterval(function() {
			...
			try {
				...
				win.title('Block Browser - ByteNest Help');
				
				//Change the input placeholder
				bod.find('input.i1').attr('placeholder', 'This browser has been automatically optimised for the ByteNest Help.');
			}
