...
new explorer.window()
.title('Block Browser') //set the title
...
.callback(function() {
	...
	bod.html('<button class="b1">🢀</button><button class="b2">🢂</button><input class="i1"></input><button class="b3">Go</button><iframe src="http://bing.com" class="if1"></iframe>');
