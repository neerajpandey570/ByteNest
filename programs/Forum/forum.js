...
new explorer.window()
.title('Block Browser - ByteNest Forum') //set the title
.resize(840, 510) //set the dimentions
.icon('programs/Forum/1.png') //set the icon
...
.callback(function() {
	...
	bod.html('<button class="b1"><img src="https://i.imgur.com/2TjTMxE.png" draggable="false" width="20" height="22"/><button class="b7"><img src="https://i.imgur.com/sfO4g4a.png" draggable="false" width="21" height="23"/><button class="b6"><img src="https://i.imgur.com/NANDJf8.png" draggable="false" width="20" height="22"/></button><button class="b2"><img src="https://i.imgur.com/Af5inxU.png" draggable="false" width="20" height="22"/><button class="b4"><img src="https://i.imgur.com/m1ur3mh.png" draggable="false" width="20" height="22"/></button><button class="b5"><img src="https://i.imgur.com/ptqaUfE.png" draggable="false" width="20" height="22"/></button></button><input class="i1"></input><button class="b3"><img src="https://i.imgur.com/YiWAXpO.png" draggable="false" height="22"/></div></button><iframe src="http://forum.ByteNest.co.uk" class="if1"></iframe>');
	...
	function startTracker() {
		...
		var interval = setInterval(function() {
			...
			try {
				...
				win.title('Block Browser - ByteNest Forum');
				
				//Change the input placeholder
				bod.find('input.i1').attr('placeholder', 'This browser has been automatically optimised for the ByteNest Forum.');
			}
