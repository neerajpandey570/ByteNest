...
.resize(790, 780) //set the dimentions
...
.callback(function() {
	...
	bod.html('<button class="b1">🢀</button><button class="b2">🢂</button><input class="i1"></input><button class="b3">Go</button><iframe src="programs/Projects/proj.htm" class="if1"></iframe>');
