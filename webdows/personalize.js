...
.callback(function() {
	...
	.html('Win Aero: <input value="webdows" type="radio" name="theme"> | Basic: <input value="basic" type="radio" name="theme"> | Classic: <input value="classic" type="radio" name="theme"><img class="webdows" src="./resources/explorer/webdows/thumbnail.png"><img class="bg"><img class="classic" src="./resources/explorer/classic/thumbnail.png"><img class="basic" src="./resources/explorer/basic/thumbnail.png"><br><input type="color" title="Pick a theme color"><button class="bac" title="Pick a background">Background</button><button class="sav">Save</button><button class="app">Apply</button><button class="can">Cancel</button>')
	.find('img')
