...
.callback(function() {
	...
	var body = this.body;
	var window = this;
	body.html('<div style="display:flex;"><img src="./resources/icons/runi.ico" style="height:32px;width:32px;margin:16px;display:inline-block;"><span class="instruct" style="margin-top:16px;">Type the name of a program or resource and BN WebOS will open it for you.</span></div><span style="margin-left:16px;">Open:</span><input type="text" style="margin-left:14px;width:310px;"><div style="position:absolute;left:0px;bottom:0px;background-color:rgba(0,0,0,.05);width:100%;height:64px;"><button class="can">Cancel</button><button class="ok">OK</button></div>');
